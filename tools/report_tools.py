...
def generate_excel_report(data_json: str, filename: str = "report.xlsx") -> str:
    ...
    Args:
        data_json (str): JSON 형태의 데이터 문자열
        filename (str): 저장할 파일명 (기본값: report.xlsx)
...
def generate_monthly_purchase_closing_report() -> str:
    ...
    내자/외자 구분, 전월 대비 증감 등의 KPI를 계산합니다.

    Returns:
        str: 마크다운 요약 결과 및 생성된 파일 경로
    """
    ...
    try:
        ...
        # Sheet 2: Top_Items (해당 월 데이터 필터링)
